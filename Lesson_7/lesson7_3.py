...
class Cell:
    ...
    def __sub__(self, other):
        if self.cell > other.cell:
            return f'Вычитание двух клеток - {self.cell - other.cell}'
        else:
            return f'Получается отрицательное число'

    def __mul__(self, other):
        return f'Умножение двух клеток - {self.cell * other.cell}'
